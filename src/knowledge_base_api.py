...
def create_knowledge_base_router() -> APIRouter:
    ...
    async def export_knowledge(filepath: str, knowledge_base: KnowledgeBase = Depends(get_knowledge_base)):
    ...
    async def store_knowledge(key: str, knowledge: dict, knowledge_base: KnowledgeBase = Depends(get_knowledge_base)):
    ...
    async def retrieve_knowledge(key: str, knowledge_base: KnowledgeBase = Depends(get_knowledge_base)):
    ...
    async def import_knowledge(filepath: str, knowledge_base: KnowledgeBase = Depends(get_knowledge_base)):
    ...
    async def get_all_knowledge(knowledge_base: KnowledgeBase = Depends(get_knowledge_base)):
        """Retrieves all knowledge from the knowledge base."""
